                    ...
                    <div class="relative text-sm">
                        ...
                        <div id="userMenu" class="bg-white rounded shadow-md mt-2 absolute mt-12 top-0 right-0 min-w-full overflow-auto z-30 invisible">
                            <ul class="list-reset">
                                ...
                                <li><a href="#" class="px-4 py-2 block text-gray-900 hover:bg-red-400 no-underline hover:no-underline">Logout</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                    ...
                    <li class="mr-6 my-2 md:my-0">
                        <a href="#" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-red-500">
                            <i class="fa fa-wallet fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Payment</span>
                        </a>
                    </li>
                </ul>
                    ...
                    <div class="bg-white border rounded shadow p-2">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-500">E-commerce Management</h5>
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-3">
                    ...
                    <div class="bg-white border rounded shadow p-2">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-500">Job Management</h5>
                ...
                <div class="w-full md:w-1/2 p-3">
                    ...
                    <div class="bg-white border rounded shadow">
                        <div class="border-b p-3">
                            <h5 class="font-bold uppercase text-gray-600">E-commerce</h5>
                        </div>
                        <div class="p-5">
                                ...
                                <tbody>
                                    <tr
                                        ...
                                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                                            <img src="https://scontent.flgp1-1.fna.fbcdn.net/v/t39.30808-6/274870967_2735914446554639_6345518842819396572_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=174925&_nc_eui2=AeEJlQp8jrTOX5UL6Tc6K3ZeAT0tFiPxqVgBPS0WI_GpWCizNTlILq2jMHvwJD3Mpmf7npdLUInlc0BKJPmXtz96&_nc_ohc=Ya9BWjUGe4IAX_H9u6w&_nc_oc=AQkpQyD1YtxH_5fXUFutYaxDUNW9WEQ5G77V0gopeuydHRjOKJ4NJzo6MzmKfPTP5ys&tn=PSAzJFMiISETfc0R&_nc_ht=scontent.flgp1-1.fna&oh=00_AT9Z6vjPMMuJOSYt4tzISEAMQCTDGWeeoKioehNY6co3Qw&oe=62979B5D" class="w-10 rounded-full" alt="profile">
                                        </th>
                                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                                            Ace Malto
                                        </th>
                                        <td class="px-6 py-4">
                                            <button class='myBtn_multi bg-red-600 hover:bg-red-400 p-2 rounded-md text-white'>View</button>
                                            <div class="modal modal_multi lg:py-48 lg:px-96 sm:px-16 sm:py-32 hidden fixed w-full h-100 inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster"
                                                style="background: rgba(0,0,0,.7);">
                                                    <div class="modal-content py-4 text-left px-6">
                                                        <!--Title-->
                                                        <div class="flex justify-between items-center pb-3">
                                                            <div class="max-w-xs">
                                                                <div class="bg-white shadow-xl rounded-lg py-3 sm:px-4 lg:px-10">
                                                                    ...
                                                                    <div class="photo-wrapper p-2">
                                                                        <img class="w-32 h-32 rounded-full mx-auto" src="https://scontent.flgp1-1.fna.fbcdn.net/v/t39.30808-6/274870967_2735914446554639_6345518842819396572_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=174925&_nc_eui2=AeEJlQp8jrTOX5UL6Tc6K3ZeAT0tFiPxqVgBPS0WI_GpWCizNTlILq2jMHvwJD3Mpmf7npdLUInlc0BKJPmXtz96&_nc_ohc=Ya9BWjUGe4IAX_H9u6w&_nc_oc=AQkpQyD1YtxH_5fXUFutYaxDUNW9WEQ5G77V0gopeuydHRjOKJ4NJzo6MzmKfPTP5ys&tn=PSAzJFMiISETfc0R&_nc_ht=scontent.flgp1-1.fna&oh=00_AT9Z6vjPMMuJOSYt4tzISEAMQCTDGWeeoKioehNY6co3Qw&oe=62979B5D" alt="John Doe">
                                                                    </div>
                                                                    <div class="p-2">
                                                                        <h3 class="text-center text-xl text-gray-900 font-medium leading-8">Ace Malto</h3>
                                                                        ...
                                                                        <table class="text-xs my-3">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="px-2 py-2">Albay, Tabaco City</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="px-2 py-2 text-gray-500 font-semibold">Phone</td>
                                                                                    <td class="px-2 py-2">+63 955221114</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="px-2 py-2 text-gray-500 font-semibold">Email</td>
                                                                                    <td class="px-2 py-2">acemalto9@gmail.com</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="px-2 py-2 text-gray-500 font-semibold">BirthDay</td>
                                                                                    <td class="px-2 py-2">12 / 12 / 2012</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <!-- <td class="px-2 py-2"><i class="fab fa-instagram text-red-300 text-2xl"></i></td> -->
                                                                                    <ul class="flex flex-row gap-2 mt-4">
                                                                                        <!-- instagram -->
                                                                                        <a href="#_" target="_blank">
                                                                                            <svg class="h-10 w-10 text-red-700 hover:text-red-400 transition" fill="currentColor" style="enable-background:new 0 0 56.7 56.7;" version="1.1" viewBox="0 0 56.7 56.7" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                                                                <g>
                                                                                        ...
                                                                                        <!-- linkedin -->
                                                                                        <a href="#_" target="_blank">
                                                                                            <svg class="h-10 w-10 text-blue-700 hover:text-blue-700 transition" fill="currentColor" style="enable-background:new 0 0 56.7 56.7;" version="1.1" viewBox="0 0 56.693 56.693" width="56.693px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                                                                <g>
                                                                                        ...
                                                                                        <!-- github -->
                                                                                        <a href="#_" target="_blank">
                                                                                            <svg class="h-10 w-10 text-gray-700 hover:text-gray-400 transition" fill="currentColor" style="enable-background:new 0 0 56.7 56.7;" version="1.1" viewBox="-1163 1657.697 56.693 56.693" width="56.693px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                                                                <g>
